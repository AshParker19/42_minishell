...
/*   Updated: 2023/10/27 19:54:46 by astein           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// TODO:
	// All the function like mark_seps, expand_vars, etc. 
	// should return if they succeded if not the manage input should be exited
	// this means we need to free the cycle as well
