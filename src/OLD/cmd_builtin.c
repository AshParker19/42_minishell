...
void	initialize_builtins(t_mbox *mbox)
{
	...
	mbox->exec.builtins[10].cmd_name = "help";
	mbox->exec.builtins[10].func_name = builtin_help;
	mbox->exec.builtins[11].cmd_name = NULL;
	mbox->exec.builtins[11].func_name = NULL;
}
